...
function TreatmentPage1({ pageData }) {
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="/services" className="hover:underline text-sm sm:text-base">Services</a></li>
                  <li><a href="/contect" className="hover:underline text-sm sm:text-base">Contact Us</a></li>
                </ul>
              </div>
            </div>
